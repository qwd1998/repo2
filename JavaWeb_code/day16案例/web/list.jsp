...
<head>
    ...
    <script>
        ...
        window.onload = function () {
            document.getElementById("zong").onclick = function () {
                //2.获取下边列表中所有的cb
            ...
            document.getElementById("delSelected").onclick = function () {
                ...
                if (confirm("确定要删除选中的条目吗")) {
                    ...
                    if (flag) {//有条目被选中
                        //表单提交
                        document.getElementById("formti").submit();
                    }
                }
            }
            }
...
<div class="container">
    ...
    <form id="formti" action="${pageContext.request.contextPath}/delSelectedServlet" method="post">
...
&name=${condition.name[0]}&address=${condition.address[0]}&email=${condition.email[0]}">${i}</a>
                            </li>
                        </c:if>
